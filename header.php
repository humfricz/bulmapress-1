        ...
        <div class="container">
            <nav class="nav">
                ...
                <div id="nav-menu" class="nav-right nav-menu">
                    <!--
                    <a class="nav-item" href="--><?php //echo site_url(); ?><!--/archive">
                        Archive
                    </a>
                    <a class="nav-item" href="--><?php //echo site_url(); ?><!--/articles">
                        Articles
                    </a>
                    <a class="nav-item" href="--><?php //echo site_url(); ?><!--/videos">
                        Videos
                    </a>
                    <a class="nav-item" href="--><?php //echo site_url(); ?><!--/templates">
                        <span>Templates</span><span class="tag is-small is-success">New!</span>
                    </a>
                    -->
                    ...
                    <a class="nav-item <?php if ( get_queried_object()->post_name == 'portfolio' ) { ?>is-active<?php } ?>" href="<?php echo site_url(); ?>/portfolio">
                        Portfolio
                    </a>
